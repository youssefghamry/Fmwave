...
$title_before = esc_html__( 'Add to Wishlist', 'fmwave' );
$title_after  = esc_html__( 'Aleady exists in Wishlist! Click here to view Wishlist', 'fmwave' );
...
if ( $text ) {
	$html .= '<span>' . esc_html__( 'WishList', 'fmwave' ) . '</span>';
}

$nonce =  wp_create_nonce( 'fmwave_wishlist_nonce' );
